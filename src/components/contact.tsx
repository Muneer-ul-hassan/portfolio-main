...
export function Contact() {
  ...
  const contactInfo = {
    ...
    handle: '@Muneer.hassan',
    socials: [
      {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/muneer-ul-hassan/',
      },
      {
        name: 'Instagram',
        url: 'https://www.instagram.com/_muneersyedd/',
      },
      {
        name: 'Discord',
        url: 'https://discord.com/users/noob_masterop',
      },
      {
        name: 'Github',
        url: 'https://github.com/Muneer-ul-hassan',
      },
      {
        name: 'Youtube',
        url: 'https://www.youtube.com/@mystery_my1',
      },      
    ],
  };
